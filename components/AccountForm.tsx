            ...
            <div className="md:flex md:items-center md:justify-between">
                <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 text-zinc-400">
                        <T>Bine ai revenit,</T> <span className="text-white font-semibold">{user?.email}</span>
                    </p>
                </div>
                ...
                {!isEditing ? (
                    <div className="bg-zinc-900/50 rounded-lg p-6 border border-zinc-800 max-w-4xl">
                        <div className="flex justify-end mb-6">
                            ...
                            >
                                <T>Modifică Profilul</T>
                            </button>
                        </div>
                        <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                            <div className="sm:col-span-1">
                                <dt className="text-sm font-medium text-zinc-400"><T>Apelativ</T></dt>
                                <dd className="mt-1 text-sm text-white"><T>{profile?.title || '-'}</T></dd>
                            </div>
                            <div className="sm:col-span-1">
                    ...
                    <form onSubmit={handleSubmit} className="bg-zinc-900/50 rounded-lg p-6 border border-zinc-800 max-w-4xl">
                        <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div className="sm:col-span-6">
                                <label htmlFor="title" className="block text-sm font-medium leading-6 text-zinc-400"><T>Apelativ</T></label>
                                <div className="mt-2">
                                    <select
                                        name="title"
                                        id="title"
                                        ...
                                        className="block w-full sm:max-w-md rounded-md border-0 bg-white/5 py-1.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-red-500 sm:text-sm sm:leading-6 pl-3 appearance-none cursor-pointer"
                                    >
